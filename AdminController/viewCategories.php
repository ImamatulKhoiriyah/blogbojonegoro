...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">CATEGORY ARTICLE</h1>
  ...
  <!-- Edit Category Modal -->
    ...
    <div class="modal-header">
        ...
        <div class="form-group">
        <label class="control-label" for="ket">Category Description</label>
        <input type="text" class="form-control" name="keterangan" value="<?= $row['keterangan'] ?>" required>
    </div>
    <div class="modal-footer">
                 <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Close</button>
        <button class="btn btn-primary" type="submit" name="catedit">Edit Category</button>
</div>                    
</div>
    </form>
</div>
   ...
   <!-- Delete Category Modal -->
    ...
    <div class="modal-body">
    <div class="modal-footer">
        <h5 class="text-center">Are you sure you want to delete this category? <br>
        <span class="text-danger"> <?=$row['nama_kategori']?></span>
        </h5>
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <form action="act_category.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Close</button>
                        <button class="btn btn-primary" type="submit" name="catsave">Add Category</button>
                        </div>       
            </form>
        </div>
    </div>
